...
var productSlideshow = {
  init: function() {
    ...
    this.slideCount = $(
      selectors$21.productSlideshowSlide,
      this.$productSlideshow
    ).length;
    if (this.slideCount > 1) {
      this.slider = new Slider($(selectors$21.slider, this.$productSlideshow));
    }
  },
  ...
  showSlideshow: function() {
    ...
    // images
    $(selectors$21.productSlideshowImage, this.$productSlideshow).addClass(
      classes$19.lazypreload
    );
    ...
    return sections.getInstances('header-section').then(
      function(instances) {
        ...
        this.$productSlideshow
          .addClass(classes$19.showProductSlideshow)
  ...
  hideSlideshow: function() {
    ...
    return sections.getInstances('header-section').then(
      function(instances) {
        ...
        this.$productSlideshow
          .removeClass(classes$19.showProductSlideshow)
  ...
  _assignEventHandlers: function() {
    ...
    this.$productSlideshow
      ...
      .on('click', selectors$21.productSlideshowSelect, this._setSlide.bind(this))
      .one(
        'click',
        selectors$21.productSlideshowClose,
        this.hideSlideshow.bind(this)
      )
      .one('click', selectors$21.productSlideshowNext, this._nextSlide.bind(this))
      .one(
        'click',
        selectors$21.productSlideshowPrevious,
  ...
  _getSlideIndex: function(id) {
    return $(selectors$21.productSlideshowSlide, this.$productSlideshow)
      .filter('[data-id="' + id + '"]')
      .index();
  },
    ...
    return this.slider.nextSlide().then(
      function() {
        this.$productSlideshow.one(
          'click',
          selectors$21.productSlideshowNext,
  ...
  _setSlideIndicator: function(evt, data) {
    ...
    $(selectors$21.productSlideshowSelect, this.$productSlideshow)
      .eq(index)
      .addClass(classes$19.productSlideshowSelectActive)
      .siblings()
      .removeClass(classes$19.productSlideshowSelectActive);
  },
...
sections.register('product-template', {
  ...
  _handleFixedSideImage: function() {
    ...
    $(selectors$20.productFormWrapper, this.$container).css({
      transform: 'translateY(' + translate + 'px)',
      position: 'absolute'
    });
  },
...
//             $(selectors$20.productFormWrapper)
//               .css('width', this.formWidth)
//               .removeClass(classes$18.productFormFixed)
//               .addClass(classes$18.productFormBottom);
//           } else {
//             // Fix to the side
//             this.coverPosition = 'fixed';
//             $(selectors$20.productFormWrapper)
//               .css('width', this.formWidth)
//               .addClass(classes$18.productFormFixed)
//               .removeClass(classes$18.productFormBottom);
//           }
//         } else {
//           // Fix to the top
//           this.coverPosition = 'top';
...
//     );
  ...
  _updateMeasurements: function() {
    var $formWrapper = $(selectors$20.productFormWrapper);
    var descriptionHeight = $(selectors$20.productDescription).outerHeight(true);
...
sections.register('quotes-section', {
  onLoad: function() {
    this.$container = $(this.container);
    this.$slider = $(selectors$22.slider, this.$container);
    this.totalSlides = this.$slider.data('count');
    this.speed = this.$slider.data('speed');
    this.currentSlide = 0;

    if (this.$slider.find(selectors$22.slide).length > 1) {
      this._startSlider();
    }
  },
  ...
  _showSlide: function(slide) {
    this.$slider
      .find(selectors$22.slide)
      .removeClass(classes$20.visible)
      .end()
      .find(slide)
      .addClass(classes$20.visible);
  },
  ...
  onBlockSelect: function(evt) {
    ...
    var $selectedSlide = this.$container.find(
      selectors$22.slide + '--' + evt.detail.blockId
    );
